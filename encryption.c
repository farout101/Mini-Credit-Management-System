...
void encryptPassword(const char password[], const char key[], char encryptedPassword[]) {
    ...
    for (size_t i = 0; i < len; ++i) {
        ...
        // Ensure that the encrypted character falls within the range of printable ASCII characters (32 to 126)
...
void decryptPassword(const char encryptedPassword[], const char key[], char decryptedPassword[]) {
    ...
    for (size_t i = 0; i < len; ++i) {
        ...
        // Ensure that the decrypted character falls within the range of printable ASCII characters (32 to 126)
